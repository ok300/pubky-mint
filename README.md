# pubky-mint
A refreshing way to browse

## What this is

An RSS-like way to browse your follows' activity on Pubky.

This lets you see and explore a user's actions, without being distracted by flashy video previews or media attachments.

You can see every action a user takes, including tagging, follows, bookmarks or replies.
